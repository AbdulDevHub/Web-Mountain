...
const raw: Omit<GitmojiEntry, "text">[] = [
  { emoji: "🎨", type: "style", description: "Improve structure or formatting of the code.", aliases: ["structure", "formatting", "layout", "organize code"] },
  { emoji: "⚡️", type: "perf", description: "Improve performance.", aliases: ["speed up", "optimize", "faster", "performance"] },
  ...
  { emoji: "✨", type: "feat", description: "Introduce new features.", aliases: ["new feature", "add capability", "implement"] },
  { emoji: "📝", type: "docs", description: "Add or update documentation.", aliases: ["docs", "readme", "documentation", "comments in docs"] },
  { emoji: "🚀", type: "chore", description: "Deploy or ship stuff.", aliases: ["deploy", "deployment", "release to production", "ship"] },
  ...
  { emoji: "🚨", type: "fix", description: "Fix compiler or linter warnings.", aliases: ["linter warnings", "compiler warnings", "eslint errors", "type errors"] },
  ...
  { emoji: "⬆️", type: "chore", description: "Upgrade dependencies.", aliases: ["upgrade dependency", "bump package version", "update packages"] },
  ...
  { emoji: "📈", type: "feat", description: "Add or update analytics or tracking code.", aliases: ["analytics", "tracking", "telemetry", "metrics"] },
  { emoji: "♻️", type: "refactor", description: "Refactor code without changing behavior.", aliases: ["refactor", "restructure code", "clean up implementation", "simplify logic"] },
  ...
  { emoji: "📦️", type: "build", description: "Add or update compiled files or packages / build output.", aliases: ["build output", "compiled files", "bundle"] },
  ...
  { emoji: "🗃️", type: "db", description: "Perform database related changes, schema or migrations.", aliases: ["database", "schema change", "migration", "sql"] },
  ...
  { emoji: "🚩", type: "feat", description: "Add, update, or remove feature flags.", aliases: ["feature flag", "toggle feature", "kill switch"] },
  ...
  { emoji: "🧑‍💻", type: "dx", description: "Improve developer experience.", aliases: ["developer experience", "dx", "tooling improvement"] },
  ...
  { emoji: "📈", type: "chore", description: "Add or update analytics or track code.", aliases: ["add tracking", "usage metrics"] },
  { emoji: "🚀", type: "build", description: "Deploy-related changes to build/CI.", aliases: ["deployment pipeline", "publish build"] },
  { emoji: "🎨", type: "style", description: "Improve code structure or formatting only, no logic change.", aliases: ["formatting only", "prettier", "code style pass"] },
  { emoji: "⬆️", type: "deps", description: "Upgrade dependencies to newer versions.", aliases: ["update dependency version"] },
  { emoji: "🚨", type: "style", description: "Resolve linter or compiler warnings.", aliases: ["resolve warnings"] },
];
